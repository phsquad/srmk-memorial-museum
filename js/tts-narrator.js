...
const ttsLogger = {
  ...
  log(...args) { if (this.level >= 3) console.log('[ttsLogger]', ...args); },
  warn(...args) { if (this.level >= 2) console.warn('[ttsLogger]', ...args); },
  error(...args) { if (this.level >= 1) console.error('[ttsLogger]', ...args); }
};
