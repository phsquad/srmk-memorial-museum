...
/**
 * ============================================================================
 * ПРОЛОГ КНИГИ ПАМЯТИ: РЕКОНСТРУКЦИЯ ЦЕРЕМОНИИ ОТКРЫТИЯ МОНУМЕНТА
 * Адаптировано из официального сценария от 26 сентября 2025 года
 * ============================================================================
 */
const MEMORY_BOOK_PROLOGUE = {
  ...
  photo: "assets/images/memorial-bg.jpg",
...
1. **Мартынов Станислав Константинович** (выпуск 2020 г., «Пожарная безопасность») — Орден Святого Георгия, медаль «За отвагу», Орден Мужества (посмертно).
...
11. **Сербиенко Иван Павлович** (выпуск 2022 г., «Право и организация соц. обеспечения», гв. лейтенант морской пехоты 177-го полка) — Орден Мужества (посмертно).
12. **Чупин Илья Валерьевич** (выпуск 2024 г., «Пожарная безопасность») — Медаль «За отвагу», Орден Мужества (посмертно).
13. **Пономарчук Иван Сергеевич** (выпуск 2022 г., «ТО автотранспорта», 247-й ДШП) — Орден Мужества (посмертно).
...
16. **Сополев Николай Сергеевич** (выпуск 2020 г., «ТО автотранспорта», 247-й ДШП) — Орден Мужества (посмертно).
17. **Белов Сергей Александрович** (выпуск 2014 г., «ТО автотранспорта») — Медаль Суворова, Медаль Кутузова «За отвагу», два Ордена Мужества (один при жизни, второй посмертно).
18. **Нартов Павел Николаевич** (выпуск 2015 г., «ТО автотранспорта») — Орден Мужества (посмертно).
19. **Лукьяненко Игорь Владимирович** (выпуск 2022 г., «ТО автотранспорта») — Орден Мужества (посмертно).
20. **Луценко Константин Андреевич** (выпуск 2011 г., «Компьютерные системы») — Орден Мужества (посмертно).
...
`,
  pages: [{
    ...
    leftHtml: `<div class="page-header-meta"><span>ПРОЛОГ</span><span>26 СЕНТЯБРЯ 2025</span></div><div class="page-visual-frame"><img src="assets/images/memorial-bg.jpg" alt="Мемориал Славы СРМК"></div><div class="page-quote-box">«Память о человеке продолжается в его делах.»</div><div class="page-number-footer">Стр. 1</div>`,
